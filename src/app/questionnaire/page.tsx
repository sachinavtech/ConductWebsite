    ...
    <main className="flex items-center justify-center bg-white text-[#1A1A1A]">
      <div className="text-center max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link
            href="/"
            className="inline-block text-[#1A1A1A] px-6 py-3 rounded-lg text-base font-medium hover:text-[#4A4A4A] transition-colors duration-200"
          >
            ← Back to Home
          </Link>
          <a
            ...
            className="inline-block bg-[#1A1A1A] text-white px-8 py-3 rounded-lg text-base font-medium hover:bg-[#333333] transition-colors duration-200"
          >
            Talk to the team
          </a>
        </div>
